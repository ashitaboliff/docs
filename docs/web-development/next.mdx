...
`layout.tsx`は名前の通りレイアウトです。正直あんまり気にしなくてOK!
...
const AboutPage = () => {
  return (
    <div className="p-8">
      ...
      <p className="mb-4">Next.jsが利用するReactの機能とルーティングについてのためのページです。</p>
      <Counter />
    </div>
  );
};
...
:::tip
Next.jsの詳しい使い方や高度な機能については公式ドキュメントを参照してください。英語しかないけど頑張れ！  
